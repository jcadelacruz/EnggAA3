...
//1.RESIDENTIAL ZONE (1)
    var dorms = new Component("DORM", "dorm", "21.5%", "37%", "43%", "8.5%" , "0", "rgb(221 196 245)", "This is breindel yes", "#574964", "dormsZone.html");
    let vs = [
    0,0,
    13.7,0,
    13.7,8.2,
...
//2.ACADEMIC ZONE (3)
    var classrms = new Component("CLASSRMS", "classrms", "11%", "34%", "67.65%", "18%" , "0", blue, "hrm chem bio", "#9EC6F3", "academicZone.html");
    var labs = new Component("LABORATORIES", "labs", "10%", "27.5%", "83.4%", "24.5%" , "0", blue, "hrm chem bio", "#9FB3DF", "academicZone.html");
    var acadAttach = new Component("XACAD", "acadAttach", "26%", "20%", "67.6%", "5.5%" , "0", blue, "hrm chem bio", "#C6E7FF", "academicZone.html");
    vs = [
    0,0,
    16.7,0,
    16.7,9.62,
...
//3.REST ZONE (7)
    var cafeteria = new Component("CAFETERIA", "cafeteria", "20%", "16.5%", "53.63%", "58.5%", "0", green, "smol", "#BAD8B6", "restZone.html");
    cafeteria.mapComponent.style.borderRadius = "100000px";
    var rest = new Component("REST AREA", "rest", "7.8%", "12.8%", "55.8%", "27%" , "0", green, "hrm chem bio", "#AAB99A", "restZone.html");
    
    var forest = new Component("FOREST", "forest" , "10.5%", "63%", "89%", "2%" , "0", green, "This is breindel yes", "#727D73", "restZone.html", 1.5);
    ...
    var kala = new Component("KALA LANE", "kala", "4%", "17%", "61.3%", "40.5%", "0", green, "smol", "#F0F0D7", "restZone.html");
    var grandstand = new Component("GRANDSTAND", "grandstand", "4.4%", "3.8%", "51.8%", "52.3%", "0", green, "smol", "#E1EACD", "restZone.html");
    var garden = new Component("GARDEN", "garden", "5.1%", "4.2%", "73.8%", "52%" , "0", green, "hrm chem bio", "#D0DDD0", "restZone.html");
...
//5.SPORTS ZONE (2)
    var gym = new Component("GYM", "gym", "50%", "34%", "5%" , "47.86%", "11.6", red, "hrm chem bio", "#DC8686","sportsZone.html", 1.7);
    vs = [
    4,0,
    26.65,0,
    26.65,5.3,
    ...
    var field = new Component("FIELD", "field", "27%", "20.3%", "16.15%" , "60.55%", "12", red, "hrm chem bio", "#D37676","sportsZone.html", 1.7);
